CREATE DATABASE sistema_ocorrencias;
...
CREATE TABLE `blocos` (
  ...
  `estado` tinyint(1) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `equipamentos` (
  ...
  `Estado_Equipamento` varchar(30) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `equipamentos_localizacao` (
  ...
  `Estado_localizacao` varchar(25) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `ocorrencias` (
  ...
  `equipamento` varchar(100) DEFAULT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `utilizadores` (
  ...
  `nivel` enum('administrador','utilizador','tecnico') NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
